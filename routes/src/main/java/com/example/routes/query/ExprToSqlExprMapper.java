...
import com.example.routes.query.parsing.IExprVisitor;
...
public class ExprToSqlExprMapper implements IExprVisitor<SqlExpr> {
    ...
    private SqlExpr translateTimeLiteral(Expr.Apply apply) {
        ...
        return new SqlExpr.DateTimeFuncCallOp("make_timestamptz", parts);
    }
        ...
        switch (term) {
            ...
            case QueryTerms.NotEqual: {
                ...
                switch (sqlLeft.type) {
                    ...
                    break;
                    case DateTime: {
                        result = this.makeCompareDatesOp(term, Utils.as(SqlExpr.DateTime.class, sqlLeft), Utils.as(SqlExpr.DateTime.class, sqlRight));
                    }
                    break;
                    default:
    ...
    private SqlExpr makeCompareDatesOp(String term, SqlExpr.DateTime left, SqlExpr.DateTime right) {
        return new SqlExpr.CompareDatesOp(SqlCompareOp.parseTerm(term), left, right);
    }
    ...
    public SqlExpr visitSymbol(Expr.Symbol symbol) {
        ...
        switch (fieldInfo.type) {
            ...
            case Number:
                ...
                break;
            case DateTime:
                result = new SqlExpr.DateTimeFieldRef(fieldInfo.sqlViewName);
                break;
            case Bool:
            default:
